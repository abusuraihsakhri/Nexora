...
- capability objects
- Phase 11.1 deny-by-default policy engine with attenuation, revocation, audit, and slot reclamation
...
7. policy/resource locking and authorization-to-commit experiments
